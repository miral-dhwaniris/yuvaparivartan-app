...
public class CampVisitFeesCollected extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.campvisit_fees_collected);

        listServ.add("Gujarat");
        listServ.add("Maharashtra");
        listServ.add("Karnataka");
        context = CampVisitFeesCollected.this;
        ...
        state_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new SpAdapter(CampVisitFeesCollected.this, listServ);
                adapter.notifyDataSetChanged();
                new android.support.v7.app.AlertDialog.Builder(CampVisitFeesCollected.this)
                        .setTitle("States")
