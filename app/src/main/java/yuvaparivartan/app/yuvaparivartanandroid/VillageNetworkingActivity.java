...
public class VillageNetworkingActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.village_networking_activity);
        ...
        state_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new SpAdapter(VillageNetworkingActivity.this, listServ);
                adapter.notifyDataSetChanged();
                new android.support.v7.app.AlertDialog.Builder(VillageNetworkingActivity.this)
                        .setTitle("States")
