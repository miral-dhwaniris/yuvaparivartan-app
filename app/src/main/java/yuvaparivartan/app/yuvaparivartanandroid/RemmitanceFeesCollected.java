...
public class RemmitanceFeesCollected extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remmitance_fees_collected);

        listServ.add("Gujarat");
        listServ.add("Maharashtra");
        listServ.add("Karnataka");
        context = RemmitanceFeesCollected.this;
        ...
        state_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new SpAdapter(RemmitanceFeesCollected.this, listServ);
                adapter.notifyDataSetChanged();
                new android.support.v7.app.AlertDialog.Builder(RemmitanceFeesCollected.this)
                        .setTitle("States")
