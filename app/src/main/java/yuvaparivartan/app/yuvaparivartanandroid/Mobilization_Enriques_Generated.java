...
public class Mobilization_Enriques_Generated extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mobilization_enquire_generated);
        ...
        state_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new SpAdapter(Mobilization_Enriques_Generated.this, listServ);
                adapter.notifyDataSetChanged();
                new android.support.v7.app.AlertDialog.Builder(Mobilization_Enriques_Generated.this)
                        .setTitle("States")
