...
public class DocsVoucherSubmitted extends ActionBarActivity {

    private EditText amount_of_voucher;
    ...
    public void commonInitialization() {
        context = DocsVoucherSubmitted.this;
        ...
        amount_of_voucher = (EditText) findViewById(R.id.amount_of_voucher);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.docs_voucher_submitted);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(new CommonFunction().applyFormRules(rulesValidation(),fieldLabels(),true,context).equals("")==true) {
                        ...
                        saveObject.put("amount_of_voucher", amount_of_voucher.getText().toString().trim());
    ...
    public JSONObject rulesValidation()
    {
        ...
        try {
            ...
            rules.put("amount_of_voucher",new CommonFunction().rule_required);
    ...
    public JSONObject fieldLabels()
    {
        ...
        try {
            ...
            labels.put("amount_of_voucher","Voucher");
