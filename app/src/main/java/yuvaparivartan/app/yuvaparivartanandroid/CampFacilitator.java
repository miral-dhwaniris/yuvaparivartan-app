...
public class CampFacilitator extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        state_et.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapter = new SpAdapter(CampFacilitator.this, listServ);
                adapter.notifyDataSetChanged();
                new android.support.v7.app.AlertDialog.Builder(CampFacilitator.this)
                        .setTitle("States")
